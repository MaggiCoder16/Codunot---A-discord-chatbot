...
async def decide_visual_type(user_text: str, chan_id: str) -> str:
    ...
    prompt = (
        ...
        "- If the user requests any type of content containing sex, NSFW content, or content inappropriate for minors, return TEXT. Light romance and kissing are allowed, though, and go in fun/video, based on the users prompt.\n"
		"- Examples -"
		...
		"4) @Codunot generate an image/video of a hot girl with big boobs - return TEXT"
		"5) @Codunot generate an image/video of a hot girl stuffing her boobs into a mans dick - return TEXT"
		"6) @Codunot generate an image/video of a girl holding a boys hand, walking together happily - return fun/video"
